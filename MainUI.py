...
class HomePage(Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.img = ImageTk.PhotoImage(Image.open("Screenshots/Sudoku_Puzzle_by_L2G-20050714_standardized_layout.svg.png").resize((490, 450), Image.ANTIALIAS))
        ...
        self.mylink = Label(self, text="Developed by Sreyansh Baranwal", borderwidth=3, relief=SUNKEN, fg="blue",
                            cursor="hand2")

        self.mylink.grid(row=5, columnspan=6, sticky="ew")
        self.mylink.bind("<Button-1>", lambda e: self.callback("https://github.com/SREYANSH2412"))
...
class StagesFrame(Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.img = ImageTk.PhotoImage(Image.open("Screenshots/Sudoku_Puzzle_by_L2G-20050714_standardized_layout.svg.png").resize((490, 490), Image.ANTIALIAS))
        self.imgpanel = Label(self, image=self.img)
